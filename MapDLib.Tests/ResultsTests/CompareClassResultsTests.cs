namespace MapDLib.Tests.ResultsTests {
	...
	public class CompareClassResultsTests : BaseTest {
		...
		public void NoChanges_NoDifferences() {
			...
			List<PropertyChangedResults> changes = MapD.Compare<Class_With_Properties_Type, Class_With_Properties_Type>( source, destination );
			...
			foreach ( PropertyChangedResults change in changes ) {
				...
				switch ( sourceChanges.PropertyName ) {
					case "Integer":
						...
						Assert.AreEqual( destination.Integer, destinationChanges.PropertyValue );
						break;
					case "Char":
						...
						Assert.AreEqual( destination.Char, destinationChanges.PropertyValue );
						break;
					case "Double":
						...
						Assert.AreEqual( destination.Double, destinationChanges.PropertyValue );
						break;
					case "String":
						...
						Assert.AreEqual( destination.String, destinationChanges.PropertyValue );
						break;
					case "Guid":
						...
						Assert.AreEqual( destination.Guid, destinationChanges.PropertyValue );
						break;
					default:
		...
		public void Dissimilar_Class_Changed() {
			...
			MapD.Config.CreateMap<Dissimilar_Type1, Dissimilar_Type2>();
			...
			List<PropertyChangedResults> changes = MapD.Compare<Dissimilar_Type1, Dissimilar_Type2>( source, destination );
