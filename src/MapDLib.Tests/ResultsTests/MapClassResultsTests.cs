namespace MapDLib.Tests.ResultsTests {
	...
	public class MapClassResultsTests : BaseTest {
		...
		public void NoChanges_NoDifferences() {
			...
			List<PropertyChangedResults> changes = MapD.Copy<Class_With_Properties_Type, Class_With_Properties_Type>( source, ref destination );
		...
		public void Dissimilar_Class_Changed() {
			...
			List<PropertyChangedResults> changes = MapD.Copy<Dissimilar_Type1, Dissimilar_Type2>( source, ref destination );
