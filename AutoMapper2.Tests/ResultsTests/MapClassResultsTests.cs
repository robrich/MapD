namespace AutoMapper2Lib.Tests.ResultsTests {
	...
	public class MapClassResultsTests : BaseTest {
		...
		public void NoChanges_NoDifferences() {
			...
			List<PropertyChangedResults> changes = AutoMapper2.Map<Class_With_Properties_Type, Class_With_Properties_Type>( source, ref destination );
		...
		public void Dissimilar_Class_Changed() {
			...
			List<PropertyChangedResults> changes = AutoMapper2.Map<Dissimilar_Type1, Dissimilar_Type2>( source, ref destination );
