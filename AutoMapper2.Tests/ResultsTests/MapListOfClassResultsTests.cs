namespace MapDLib.Tests.ResultsTests {
	...
	public class MapListOfClassResultsTests : BaseTest {
		...
		public void NullSourceandDestList_NoChanges() {
			...
			List<PropertyChangedResults> changes = MapD.Copy<List<SimplePrimaryClass>, List<SimplePrimaryClass>>( source, ref destination );
		...
		public void DissimilarList_YieldDifferences() {
			...
			List<PropertyChangedResults> changes = MapD.Copy<List<SimplePrimaryClass>, List<SimplePrimaryClass2>>( source, ref destination );
