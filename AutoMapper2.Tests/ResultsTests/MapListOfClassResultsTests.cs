namespace AutoMapper2Lib.Tests.ResultsTests {
	...
	[TestFixture]
	public class MapListOfClassResultsTests : BaseTest {
		...
		public void NullSourceandDestList_NoChanges() {
			...
			List<PropertyChangedResults> changes = AutoMapper2.Map<List<SimplePrimaryClass>, List<SimplePrimaryClass>>( source, ref destination );
		...
		public void EmptySourceFullDestList_YieldDifferences() {
			...
			for ( int i = 0; i < changes.Count; i++ ) {
				...
				SimplePrimaryClass destVal = destinationReference[i];
		...
		public void DissimilarList_YieldDifferences() {
			...
			List<PropertyChangedResults> changes = AutoMapper2.Map<List<SimplePrimaryClass>, List<SimplePrimaryClass2>>( source, ref destination );
